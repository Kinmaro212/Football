...
<?php
// Inclusion des classes nécessaires pour gérer les entités de l'application
include "Carreer.php";
include "Club.php";
include "Country.php";
include "Player.php";

// Création des instances des pays pour les assigner aux clubs
...
// Création des instances de clubs réels avec leur pays d'origine
...
// Création des joueurs avec leur nom, prénom, pays et date de naissance
...
// Création et ajout des carrières de chaque joueur dans leurs clubs respectifs
...
// Ajout des joueurs dans les clubs où ils ont joué au fil des années
...
<?php
// Affichage des clubs organisés par pays
...
<?php
// Affichage des carrières individuelles de chaque joueur
...
<!-- Inclusion des scripts de UIkit pour les éléments de l'interface utilisateur -->
